...
exports.addBlog = async (req, res) => {
  ...
  try {
    let data = new Blog({
      ...
      img1: `https://instabackend-production.up.railway.app/photo/${images.photo1[0].filename}`,
      img2: `https://instabackend-production.up.railway.app/photo/${images.photo2[0].filename}`,
    });
    await data.save();
    res.status(200).json({
